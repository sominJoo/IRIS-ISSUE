        ...
        <div id="table-container" >
            <form
                ...
                <div class="d-flex justify-content-center form-dic" >
                    ...
                    <button type="button" class="btn btn-outline-danger mt-1" style="height: 65%" @click="onReset"> 초기화 </button>
                </div>
            </form>
            ...
            <div id="pagination" class="text-center mt-3">
                <div class="pagination-div overflow-auto">
                    <b-pagination v-model="currentPage" :total-rows="totalRows"  align="center" @page-click="pageList"></b-pagination>
                </div>
            </div>
        </div>
    </div>
        ...
        mounted() {
            ...
            axios
                ...
                .then(response => {
                    ...
                    this.issueList.forEach(function (value, index){
                        if (value.perPage != 0){
                            temp = value.perPage;
                        }
                    });
                    this.totalRows = temp;    //this.issueList에서 this 선언시 data()의 객체 호출 x
                });
        },
        methods: {
            //page 이동
